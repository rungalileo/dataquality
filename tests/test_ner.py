...
def test_construct_gold_sequence() -> None:
    len_sequence = 15
    case_1_seq_bio = ["O", "O", "B-PER", "I-PER", "B-ORG", "O",
                      "B-MISC", "I-MISC", "I-MISC", "O",
                      "B-PER", "B-ORG", "B-MISC", "O", "O"]
    case_1_seq_bioes = ["O", "O", "B-PER", "E-PER", "S-ORG", "O",
                        "B-MISC", "I-MISC", "E-MISC", "O",
                        "S-PER", "S-ORG", "S-MISC", "O", "O"]
    case_1_seq_bilou = ["O", "O", "B-PER", "L-PER", "U-ORG", "O",
                        "B-MISC", "I-MISC", "L-MISC", "O",
                        "U-PER", "U-ORG", "U-MISC", "O", "O"]
    case_1_spans = [
    ...
    assert case_1_seq_bio == model_logger._construct_gold_sequence(len_sequence, case_1_spans)
    model_logger.logger_config.tagging_schema = "BIOES"
    assert case_1_seq_bioes == model_logger._construct_gold_sequence(len_sequence, case_1_spans)
    model_logger.logger_config.tagging_schema = "BILOU"
    assert case_1_seq_bilou == model_logger._construct_gold_sequence(len_sequence, case_1_spans)
