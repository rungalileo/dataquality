...
def test_duplicate_rows(set_test_config, cleanup_after_use) -> None:
    ...
    dq.log_input_samples(texts=text_inputs, task_labels=gold, split="training", ids=ids)
    ...
    dq.log_input_samples(texts=text_inputs, task_labels=gold, split="test", ids=ids)
