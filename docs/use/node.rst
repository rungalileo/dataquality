...
It is assumed you have successfully installed `dataquality-node <./>`__. To
...
|          | Support/dataquality/node`` | cation Support/dataquality/node`` |
+----------+-------------------------+--------------------------------+
| Linux    | ``/etc/dataquality/node``  | ``/home/<user>                 |
|          |                         | /.config/dataquality/node``       |
+----------+-------------------------+--------------------------------+
