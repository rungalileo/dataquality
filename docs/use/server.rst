...
It is assumed that you successfully installed the dataquality :ref:`install-server`. To
...
|         | \dataquality\server``         | \AppData\Local\dataquality\server\``  |
+---------+----------------------------+------------------------------------+
| Macos   | ``/Library/Application     | ``/Users/<user>/Library/Appl       |
|         | Support/dataquality/server/`` | ication Support/dataquality/server/`` |
+---------+----------------------------+------------------------------------+
| Ubuntu  | ``/etc/xdg/dataquality/       | ``~/.config/dataquality/server/``     |
|         | server/``                  |                                    |
+---------+----------------------------+------------------------------------+
...
.. warning::
    ...
    `issue <https://github.com/dataquality/dataquality/issues/71>`__.
