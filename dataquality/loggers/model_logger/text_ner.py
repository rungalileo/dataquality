...
class TextNERModelLogger(BaseGalileoModelLogger):
    ...
    * split: The model training/test/validation split for the samples being logged
    ...
    def _extract_span_probs(
        ...
        if gold_sequence_idx is not None and len(gold_sequence_idx) == 0:
            gold_sequence_idx = None
        ...
        for span in spans:
            ...
            span_gold_seq = (
                gold_sequence_idx[start:end] if gold_sequence_idx is not None else None
            )
