...
def finish(
    ...
    :param data_embs: If True, an off-the-shelf transformer will run on the raw text
        input to generate data-level embeddings. These will be available in the
    ...
    data_logger.upload(last_epoch, data_embs=data_embs)
    upload_dq_log_file()
