...
def add_dep_to_polygon(dep_map: np.ndarray, polygon_img: np.ndarray, polygon: Polygon) -> None:
...
def add_lm_to_polygon(mislabeled_pixels: np.ndarray, polygon_img: np.ndarray, polygon: Polygon) -> None:
