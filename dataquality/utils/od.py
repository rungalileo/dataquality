...
#
#
#     Takes in gold boxes, pred_boxes, gold_labels, probs and returns dep per box,
#     matching, embeddings per matched pair, flag indicating pred or gold, and image dep
#     """
#     with torch.no_grad():
